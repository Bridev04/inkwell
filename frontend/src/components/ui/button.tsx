...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-cream active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border-stone-300 bg-cream hover:bg-stone-300/20 hover:text-ink aria-expanded:bg-stone-300/20 aria-expanded:text-ink",
        secondary:
          "bg-transparent text-ink border border-stone-300 hover:border-ink hover:bg-stone-300/20 aria-expanded:border-ink aria-expanded:bg-stone-300/20",
        ghost:
