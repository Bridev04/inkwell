...
### Completed
   ...
   - [x] QuillBot-style grammar checker v2: offset-based inline underlines, per-category score rings, Accept/Ignore with offset shifting, 800ms debounce auto-check
